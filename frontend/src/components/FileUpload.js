...
function FileUpload({ user }) {
  ...
  return (
    <div style={{ display: 'flex', gap: '96px', justifyContent: 'center', alignItems: 'center', height: '100vh' }}>
      <div>
      <form id="ransomware-form" className="form" onSubmit={handleSubmit}>
          <span className="form-title">Upload Ransomware file</span>
      ...
      <div>
      <form id="zero-day-form" className="form" onSubmit={handleSubmit}>
          <span className="form-title">Upload Zero-Day file</span>
          <p className="form-paragraph">File should be an .csv file</p>
          <label htmlFor="file-input" className="drop-container">
            <span className="drop-title">Drop files here</span>
            or
